...
const std::vector<int> &Model::GetModelSeg() const {
  return model_seg_;
}

int Model::GetMaxSegClass() const {
  return max_seg_class_;
}
...
Mesh Model::ProcessMesh(aiMesh *mesh, const aiScene *scene) {
  ...
  return Mesh(vertices, indices, textures, model_seg_);
}
...
void Model::LoadModelSeg(const std::string &seg_path) {
  // no seg path
